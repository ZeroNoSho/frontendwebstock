  ...
  return (
    <div className="w-11/12 mx-auto">
      <div className="my-5 py-5 border-b border-t border-gray-300 flex max-[550px]:block">
        <Link href={halaman || ""} className="blue text-slate-100 p-2 rounded-lg" fdprocessedid="true">
          Add item
        </Link>
        <div className="flex flex-row-reverse ml-auto max-[550px]:mt-10">
          ...
          <p className={`p-1 cursor-pointer w-20 text-center ${hidden}`} onClick={() => (col == 1 ? setCol(0) : setCol(1))}>
