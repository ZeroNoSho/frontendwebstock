...
export default function Home() {
  const { axiosJWT, token, databarang, toat } = useContext(Contex);
  ...
  return (
    <div className="mx-15 text-slate-500 max-h-full min-h-screen pb-10">
      <div className="mb-10">
        <p className="text-3xl font-semibold pt-10 text-center">Transaksi Keluar</p>
      </div>
      <div className="bg-white py-5 w-11/12 m-auto rounded-lg">
        <form onSubmit={postData} fdprocessedid="true">
          ...
          <div id="alur" className="px-10 py-1">
            <label className="font-semibold py-2">
              Alur Transaksi <input disabled={true} type="text" value="Keluar" className="w-full rounded-md p-1 border border-gray-300" fdprocessedid="true" />
            </label>
          </div>
